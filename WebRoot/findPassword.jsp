...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Duang学堂教育信息管理系统找回密码页</title>
			...
			<div class="content">
				<div id="step1" class="step hide">
					<form action="" method="post" id="step1_frm">
						...
						<div class="toolBar">
							<a id="nextBtn" class="btn btn_primary" href="login.jsp">下一步</a>
						</div>
					</form>
				</div><!-- // step1 end -->
				...
				<div id="step2" class="step hide">
					<div class="w330">
						<strong class="f16">您好！原始密码已通过邮件发送至你的注册邮箱 : <br />duhang@whut.edu.com</strong>
						<p class="c7b">请进入邮箱查看邮件，并重新登陆帐号。</p>
